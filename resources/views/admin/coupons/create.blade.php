    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="form-group" style="grid-column: 1/-1;">
                ...
                <input type="text" name="code" class="form-control" value="{{ old('code') }}" required placeholder="SUMMER2024" style="text-transform: uppercase;">
                @error('code')
            ...
            <div class="form-group" style="grid-column: 1/-1;">
                ...
                <input type="number" name="usage_limit" class="form-control" value="{{ old('usage_limit') }}" placeholder="اتركه فارغاً للاستخدام غير المحدود">
            </div>

            <div class="form-group" style="grid-column: 1/-1;">
                <label class="form-label">الخطط المتاحة (اختياري - اتركه فارغاً لجميع الخطط)</label>
