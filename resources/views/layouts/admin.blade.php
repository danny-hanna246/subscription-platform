        ...
        مفاتيح API
            ...
            <div style="position: absolute; bottom: 0; width: 260px; padding: 15px; border-top: 1px solid rgba(255,255,255,0.1);">
                <div class="flex items-center gap-1">
                    <div style="width: 40px; height: 40px; background: #34495e; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold;">
                    ...
                    <form action="{{ route('admin.logout') }}" method="POST" style="display: inline;">
                        @csrf
                        <button type="submit" style="background: none; border: none; color: #95a5a6; cursor: pointer; padding: 5px;">
